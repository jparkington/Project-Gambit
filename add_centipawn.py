...
def evaluate_chess_games(stockfish_path : str, 
    ...
    and writes the evaluated partitions to a test directory.
...
def main():
    ...
    storage_test_directory = "Games/Storage_test"             # Directory to write revised partitions
    start_ply             = 22                                # Starting total_ply value to process
